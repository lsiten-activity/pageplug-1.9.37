...
const PositionStyle = styled.div<{
  ...
  z-index: ${props => props.isTopIndex ? 1009 : Layers.widgetName};
`;
...
export function WidgetNameComponent(props: WidgetNameComponentProps) {
  ...
  const isBottomBarWidget = ["TARO_BOTTOM_BAR_WIDGET"].includes(props.type);
  const isPopModalWidget = ["TARO_POPUP_WIDGET"].includes(props.type);
  ...
  return showWidgetName ? (
    <PositionStyle
      ...
      topRow={props.topRow}
      isBottomBarWidget={isBottomBarWidget}
      isTopIndex={isPopModalWidget}
    >
      <ControlGroup>
        <SettingsControl
