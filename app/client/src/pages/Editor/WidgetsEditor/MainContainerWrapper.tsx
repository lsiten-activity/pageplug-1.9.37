...
function MainContainerWrapper(props: MainCanvasWrapperProps) {
  ...
  const heightWithTopMargin = `calc(100vh - 2rem - ${showTabBar ? "60px" : "0px"} - ${topMargin} - ${smallHeaderHeight} - ${bottomBarHeight} - ${scrollBarHeight} - ${navigationHeight}px)`;
  // const hasImageBackgroud = selectedTheme.properties.colors.backgroundUrl;
  return (
    <>
      <Wrapper
        $enableMainCanvasResizer={enableMainContainerResizer}
